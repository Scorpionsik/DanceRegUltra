...
namespace DanceRegUltra.Models
{
    ...
    public class DanceEvent : NotifyPropertyChanged, IComparable<DanceEvent>
    {
        ...
        public void AddNode(int node_id, Member member, bool isGroup, IdTitle platform, int league_id, IdTitle block, int age_id, int style_id, string scores, int position, int prize, bool isPrint)
        {
